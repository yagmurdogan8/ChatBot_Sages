...
(function($) {
    ...
    const knowledgeBase = {
        ...
        // Common Questions
        commonQuestions: {
            "hangi ülkelerde eğitim alabilirim": "🌍 <strong>SAGES'te Eğitim Alabileceğiniz Ülkeler:</strong><br/><br/>🇺🇸 <strong>ABD</strong> - Dünyanın en prestijli üniversiteleri<br/>🇬🇧 <strong>Birleşik Krallık</strong> - Tarihi ve prestijli eğitim<br/>🇩🇪 <strong>Almanya</strong> - Ücretsiz devlet üniversiteleri<br/>🇨🇦 <strong>Kanada</strong> - Yüksek yaşam kalitesi<br/>🇫🇷 <strong>Fransa</strong> - Sanat ve kültür merkezi<br/>🇮🇹 <strong>İtalya</strong> - Tasarım ve sanat eğitimi<br/>🇵🇱 <strong>Polonya</strong> - Uygun maliyetli eğitim<br/>🇭🇺 <strong>Macaristan</strong> - Orta Avrupa'nın kalbi<br/>🇱🇻 <strong>Letonya</strong> - Modern ve yenilikçi<br/>🇪🇪 <strong>Estonya</strong> - Teknoloji ve inovasyon<br/><br/>📚 <strong>Eğitim Programları:</strong><br/>• Lisans (Bachelor)<br/>• Yüksek Lisans (Master)<br/>• Doktora (PhD)<br/>• Dil Okulu<br/>• Lise Eğitimi<br/><br/>💡 <strong>Hangi ülke hakkında detaylı bilgi almak istiyorsunuz?</strong>",
            ...
            "burs imkanları neler": "🎓 <strong>Burs İmkanları:</strong><br/>• Akademik başarı bursları<br/>• Spor bursları<br/>• Sanat bursları<br/>• İhtiyaç bursları<br/>• Devlet bursları<br/>• Üniversite bursları<br/>• SAGES desteği: Burs başvuru süreci",
            "konaklama seçenekleri neler": "🏠 <strong>Konaklama Seçenekleri:</strong><br/>• Üniversite yurtları<br/>• Özel yurtlar<br/>• Ev kiralama<br/>• Aile yanında kalma<br/>• Paylaşımlı ev<br/>• SAGES desteği: Konaklama organizasyonu",
